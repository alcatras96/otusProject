...
values ('Apple Music description', 'https://i.pinimg.com/originals/67/f6/cb/67f6cb14f862297e3c145014cdd6b635.jpg', 'Apple Music', 9.99,
       ...
       ('SubscriptionModel 1',
        ...
        'SubscriptionModel 1', 9.99, (select id from categories where categories.name like 'other'),
        (select id from owners where name like 'Owner01')),
       ('SubscriptionModel 2',
        'https://media.istockphoto.com/vectors/pay-per-click-vector-id1182361258?k=20&m=1182361258&s=612x612&w=0&h=pLfZupXKAayGiTV3Odb_Z59oU-3ioJ8tZVnATDBFacg=',
        'SubscriptionModel 2', 9.99, (select id from categories where categories.name like 'other'),
        (select id from owners where name like 'Owner01')),
       ('SubscriptionModel 3',
        'https://media.istockphoto.com/vectors/pay-per-click-vector-id1182361258?k=20&m=1182361258&s=612x612&w=0&h=pLfZupXKAayGiTV3Odb_Z59oU-3ioJ8tZVnATDBFacg=',
        'SubscriptionModel 3', 9.99, (select id from categories where categories.name like 'other'),
        (select id from owners where name like 'Owner01')),
       ('SubscriptionModel 4',
        'https://media.istockphoto.com/vectors/pay-per-click-vector-id1182361258?k=20&m=1182361258&s=612x612&w=0&h=pLfZupXKAayGiTV3Odb_Z59oU-3ioJ8tZVnATDBFacg=',
        'SubscriptionModel 4', 9.99, (select id from categories where categories.name like 'other'),
        (select id from owners where name like 'Owner01')),
       ('SubscriptionModel 5',
        'https://media.istockphoto.com/vectors/pay-per-click-vector-id1182361258?k=20&m=1182361258&s=612x612&w=0&h=pLfZupXKAayGiTV3Odb_Z59oU-3ioJ8tZVnATDBFacg=',
        'SubscriptionModel 5', 9.99, (select id from categories where categories.name like 'other'),
        (select id from owners where name like 'Owner01')),
       ('SubscriptionModel 6',
        'https://media.istockphoto.com/vectors/pay-per-click-vector-id1182361258?k=20&m=1182361258&s=612x612&w=0&h=pLfZupXKAayGiTV3Odb_Z59oU-3ioJ8tZVnATDBFacg=',
        'SubscriptionModel 6', 9.99, (select id from categories where categories.name like 'other'),
        (select id from owners where name like 'Owner01')),
       ('SubscriptionModel 7',
        'https://media.istockphoto.com/vectors/pay-per-click-vector-id1182361258?k=20&m=1182361258&s=612x612&w=0&h=pLfZupXKAayGiTV3Odb_Z59oU-3ioJ8tZVnATDBFacg=',
        'SubscriptionModel 7', 9.99, (select id from categories where categories.name like 'other'),
        (select id from owners where name like 'Owner01')),
       ('SubscriptionModel 8',
        'https://media.istockphoto.com/vectors/pay-per-click-vector-id1182361258?k=20&m=1182361258&s=612x612&w=0&h=pLfZupXKAayGiTV3Odb_Z59oU-3ioJ8tZVnATDBFacg=',
        'SubscriptionModel 8', 9.99, (select id from categories where categories.name like 'other'),
        (select id from owners where name like 'Owner01'));